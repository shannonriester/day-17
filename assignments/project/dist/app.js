...
var settings = {
    ...
    success: function(response) {
        ...
        resultsArr.forEach(function(itemObj) {
            ...
            console.log(itemObj.Shop.shop_name);
        });
    }
};
